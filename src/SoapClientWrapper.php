...
namespace radomirradojevic\soap;

use SoapClient;
use SoapFault;
use yii\base\Component;
use radomirradojevic\soap\WsseAuthHeader;
...
class SoapClientWrapper extends Component
{
    ...
    public function init()
    {
        ...
        try {
            ...
            if(isset($this->headers->authDetails->wss_ns)){
			$wsse_header = new WsseAuthHeader($this->headers->authDetails->login, $this->headers->authDetails->password, $this->headers->authDetails->wss_ns);
				$this->_client->__setSoapHeaders($wsse_header);
			} else {
